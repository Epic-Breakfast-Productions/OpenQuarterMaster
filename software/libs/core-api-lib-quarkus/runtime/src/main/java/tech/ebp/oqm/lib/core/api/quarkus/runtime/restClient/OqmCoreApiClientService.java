...
import tech.ebp.oqm.lib.core.api.quarkus.runtime.restClient.models.InteractingEntity;
...
public interface OqmCoreApiClientService {
	...
	Uni<InteractingEntity> interactingEntityGetSelf(@HeaderParam(Constants.AUTH_HEADER_NAME) String token);
	//</editor-fold>
