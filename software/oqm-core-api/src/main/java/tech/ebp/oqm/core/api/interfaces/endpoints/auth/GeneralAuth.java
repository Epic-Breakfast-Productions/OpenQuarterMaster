package tech.ebp.oqm.core.api.interfaces.endpoints.auth;
...
import tech.ebp.oqm.core.api.model.rest.auth.TokenCheckResponse;
import tech.ebp.oqm.core.api.utils.TimeUtils;

import java.util.Date;

@Slf4j
@Path(EndpointProvider.ROOT_API_ENDPOINT_V1 + "/auth")
