...
<head>
	...
	<!-- CSS -->
	<link href="/lib/bootstrap/5.3.2/bootswatch.yeti.min.css" rel="stylesheet">
	<link rel="stylesheet" href="/lib/bootstrap-icons/1.11.1/bootstrap-icons.min.css">
...
<nav class="navbar navbar-expand-lg bg-light top-nav mb-2" data-bs-theme="light" id="top-nav">
	{#if navbar == "full"}
		...
		<a class="navbar-brand p-0" href="/overview">
			<img src="/media/logo.svg" alt=""  id="topLogo">
		</a>
