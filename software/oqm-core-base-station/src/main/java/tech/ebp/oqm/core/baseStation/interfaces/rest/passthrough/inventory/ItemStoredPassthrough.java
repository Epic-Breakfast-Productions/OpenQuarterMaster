...
//	}
	...
	public Uni<Response> getHistoryForObject(
		...
		Uni<ObjectNode> searchUni = this.getOqmCoreApiClient().invItemStoredSearchHistory(this.getBearerHeaderStr(), this.getSelectedDb(), this.getItemId(), storedId, searchObject);
