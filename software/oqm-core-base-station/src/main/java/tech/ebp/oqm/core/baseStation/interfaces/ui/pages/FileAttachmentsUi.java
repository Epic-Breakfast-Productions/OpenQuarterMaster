...
public class FileAttachmentsUi extends UiProvider {
	...
	@ConfigProperty(name="ui.fileAttachment.search.defaultPageSize")
	int defaultPageSize;
	
	@GET
	@Path("files")
	@RolesAllowed(Roles.INVENTORY_VIEW)
	public Uni<Response> storagePage(@BeanParam FileAttachmentSearch search) {
