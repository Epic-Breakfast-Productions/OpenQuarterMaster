...
import tech.ebp.oqm.core.api.model.validation.validators.identifiers.GTIN14Validator;
...
@Documented
public @interface ValidGTIN14 {
	
	String message() default "String was not a valid GTIN-14 code.";
