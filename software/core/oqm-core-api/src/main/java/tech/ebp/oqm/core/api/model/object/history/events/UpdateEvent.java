...
@Schema(title = "UpdateEvent", description = "An event describing an update to an object.")
public class UpdateEvent extends ObjectHistoryEvent {
	...
	@Override
	@Schema(constValue = "UPDATE", readOnly = true, required = true, examples = "UPDATE")
