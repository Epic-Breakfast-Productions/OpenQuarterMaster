...
public class StoredItemBumper5 extends ObjectSchemaVersionBumper<Stored> {
	
	public StoredItemBumper5() {
		super(5);
	}
	...
	protected SingleUpgradeResult bumpObjectSchema(ObjectNode oldObj) {
		...
		String storageBlockId = oldObj.remove("storageBlock").asText();
		ObjectNode state = oldObj.putObject("state");
		state.put("type", "STORED");
		state.put("storageBlock", storageBlockId);
