...
public abstract class UiProvider extends RestInterface {
	...
	protected TemplateInstance setupPageTemplate(Template template, InteractingEntity entity) {
		return this.setupPageTemplate(template).data(USER_INFO_DATA_KEY, entity);
	}
	...
	protected TemplateInstance setupPageTemplate(
		...
		return this.setupPageTemplate(template, entity)
