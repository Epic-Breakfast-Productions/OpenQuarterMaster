...
import com.ebp.openQuarterMaster.baseStation.rest.restCalls.productLookup.BarcodeLookupClient;
...
@Traced
@NoArgsConstructor
public class BarcodeLookupService extends ProductSearchService {
